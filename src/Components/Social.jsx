...
export const Social = () => {
  return (
    ...
    <Text size={"md"}>More Contacts :</Text>
    <Box className={styles.box}>
        ...
        <a  href={"https://drive.google.com/file/d/1N8u-FjHCRGhXKcjtRTBCPSbmEzpBHqxl/view?usp=sharing"} target="blank" ><button className={styles.resumeBtn}><ImProfile /></button></a>
    </Box>
    <Box>
