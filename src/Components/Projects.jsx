            ...
            <SimpleGrid m="0rem 2rem" columns={[1,null,2,3]} spacing={6} >
                ...
                data.map((d)=>(
                    <Box className={styles.p_box}>
                        ...
                        <Box p="1rem">
                            <a href={d.project_link} target="blank" rel="noreferrer"><button className={styles.btn}><FaExternalLinkAlt /></button></a>
                            <a href={d.git_link} target="blank" rel="noreferrer"><button className={styles.btn}><FaGithub /></button></a>
                        </Box>
                    </Box>
                ))}
